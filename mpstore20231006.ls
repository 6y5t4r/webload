...
TemplateCreatedVersion=Version 12.6.0.043.00  Supports 128 bit SSL 
TemplateLastSavedVersion=Version 12.6.0.043.00  Supports 128 bit SSL 
Agendas=webloadmpstore;
Start Time=1696621463
Report Resolution=20
Terminate Time=1696621488
Return code=0
Failure reason=Test passed
SessionCreatedVersion=Version 12.6.0.043.00  Supports 128 bit SSL 
SessionLastSavedVersion=Version 12.6.0.043.00  Supports 128 bit SSL 
[webloadmpstore]
Path=C:\Users\integrator\Documents\WebLOAD\Sessions\webloadmpstore.wlp
RelativePath=..\..\Users\integrator\Documents\WebLOAD\Sessions\webloadmpstore.wlp
ExecutionType=0
LimitRun=0
IsMix=0
...
[webloadmpstore : Browser Emulation]
...
ProxyHost=
ProxyPort=
[webloadmpstore : Options\Connection]
Speed for LG=0
Speed for PC=0
Advanced=0
...
Raw Data CSV=0
[webloadmpstore : FunctionalTesting]
...
JavaFull=0
JavaOptimized=0
[webloadmpstore : PassFailDefinition]
definitionType=1
checkErrors=1
checkSevere=1
checkStopTest=0
...
warningNum=15
SLANum=15
[webloadmpstore : SleepTimeControl]
sleepControlType=1
timeBetween=2
timeAnd=11
deviationPersent=10
...
sProxyPort=
nWSClientType=1
[webloadmpstore : ResetMechanism]
bResetEnable=0
nCreateLGRetryTimes=3
nLGTimeout=150
nResetTimeout=60
nStopLGTimeout=3
[webloadmpstore : HTTPParameters]
HTTPVersion=1
bMultiIPSupport=0
bEncodeFormData=1
bAcceptLanguage=0
StrAcceptLanguage=
[webloadmpstore : BrowserCache]
bFilterApplets=1
bFilterImages=1
bFilterJSFiles=1
